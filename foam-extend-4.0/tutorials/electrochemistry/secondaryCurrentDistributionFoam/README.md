...
**Post-processing**  
By the command line >> wallCurrrentFlux -region electrolyte -latestTime it is possible to obtain in the region: electrolyte, and by means of the post processing utility wallCurrrentFlux (supplied here) the total current and current distribution per electrode.
